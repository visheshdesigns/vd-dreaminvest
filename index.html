								...
								<li class="first-col">
									...
									<div class="widget-block">
										...
										<div class="recent-post">
											...
											<div class="post-head">
												<a href="#">Pellentesque habitant morbi senectus</a><span> March 12, 2013</span>
											</div>
										</div>
										<div class="recent-post">
											<a href="#" class="thumb"><img src="img/dummies/54x54.gif" alt="Post" /></a>
		...
		<div id="main">	
			<div class="wrapper">
				...
				<div id="slider-holder" class="clearfix">
		        	...
		        	<!-- Headline -->
		        	<div id="headline">
		        		<h1>"Dream Invest" as a Financial Consultants</h1>
		        		<p>We have developed our brand in personal financial services</p>
		        		<p>Visit our <a href="#">Services</a> for more knowleged</p>
		        		<em id="corner"></em>
		        	</div>
		        	<!-- ENDS headline -->
				...
				<!-- home-block -->
                <h2 class="page-heading"><span>Associated with LIC and other Premium Services</span></h2>
						
						<br>

						<!--<p><a href="#">Information page</a></p>-->
						
						
						<p>It is a pleasure to introduce <a href="#">"Dream Invest"</a> as a professional Group of .<br>
We are in to financial consultancy last 14 years in PUNE largely associated with LIC and other premium services.<br>
We have developed our brand in personal financial services. <br>
Our business success is credited to.</p>
			...
			<div class="wrapper">
				...
				<ul  class="widget-cols clearfix">
					...
					<li class="second-col">
						...
						<div class="widget-block">
							<h4>Dream Invest Website</h4>
							<p>Hope you find this Website useful you can use it on personal and commercial projects. See the full document by Sign Up at this <a href="#" >link</a></p>
						</div>
					...
					<li class="fourth-col">
						...
						<div class="widget-block">
							...
							<p>Thanks to <a href="#" >Akshay</a> for sharing his work as place holder images for this preview. Visit his <a href="#" >website</a> and find more of his awesome work.</p>
						</div>
